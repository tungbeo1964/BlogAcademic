        ...
        <c:if test="${not empty sessionScope.USER}">
            ...
            <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
                <div class="container px-4 px-lg-5">
                    <a class="navbar-brand" href="index.html">Welcome,${sessionScope.USER}</a>
                                ...
                                <div class="my-5">
                                    ...
                                    <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                                        <div class="form-floating">
                                            <input class="form-control"  type="text" name="mentorID" value="${param.mentorID}" placeholder="CreateMentor">
                                        ...
                                        <div class="form-floating">
                                            <input class="form-control" type="text" name="mentorName" value="${param.mentorName}" placeholder="CreateMentor">
                                        ...
                                        <div class="form-floating">
                                            <input class="form-control"  type="text" name="mentorEmail" value="${param.mentorEmail}" placeholder="CreateMentor">
                                        ...
                                        <div class="form-floating">
                                            <input class="form-control" type="text" name="mentorPhone" value="${param.mentorPhone}" placeholder="CreateMentor">
                                        ...
                                        <div class="form-floating">
                                            <input class="form-control"  type="password" name="mentorPassword" placeholder="CreateMentor">
                                        ...
                                        <div class="form-floating">
                                            <input class="form-control"  type="password" name="txtConfirm" placeholder="CreateMentor" >
                                        ...
                                        <!-- Submit Button-->
                                        <button class="btn btn-primary text-uppercase" type="submit" name="btnAction" value="Create Mentor">
                                            Create
                                        </button>
                                    </form>
                ...
                <div class="container px-4 px-lg-5">
                    <div class="row gx-4 gx-lg-5 justify-content-center">
                        <div class="col-md-10 col-lg-8 col-xl-7">
                            ...
                            <div class="small text-center text-muted fst-italic">detail group</div>
                        </div>
                    </div>
                </div>
            </footer>
