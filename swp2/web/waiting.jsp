                                        ...
                                        <table class="table" >
                                            ...
                                            <tbody>
                                                ...
                                                <form action="MainController" method="POST">
                                                    ...
                                                    <td>${listWaitingBlog.title}</td>
                                                    <td>${listWaitingBlog.createOn}</td>
                                                    <td>
                                                    ...
                                                    <td>    
                                                        <c:if test="${listWaitingBlog.status eq 1}">
                                                            <font color="olive" ><c:out value="Waiting"/></font>
                                                        </c:if>
                                                        <c:if test="${listWaitingBlog.status eq 3}">
                                                            <font color="red" ><c:out value="Unapprove"/></font>
                                                        </c:if>
                                                    </td>
                                                    <td>
                                                        <select style="border-radius: 10px"  class="input10000" name="cboSetStatus">
                                                            <option style="text-align: left; ">Approve</option>
                                                            <option style="text-align: left;">Un-Approve</option>
                                                        </select>
                                                        <span class="focus-input100"></span>
                                                        <button   style="background-color: #ffffff; border-style : hidden;font-size: 15px;color: red"
