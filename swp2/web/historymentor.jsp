          ...
          background-image: linear-gradient(315deg, #d9e4f5 0%, #f5e3e6 74%);">
                        ...
                        <form action="MainController" method="GET">
                            ...
                            <td style="color: black;">
                                <button   style="background-color: #ffffff;color: black;border-radius: 5px;border-style: solid;font-size: medium"
                                          type="submit" value="View Blog Detail Mentor" name="btnAction">
                                    View Blog
                                </button>
                            </td>
                            <td style="color: black">
                                <button   style="background-color: #ffffff; border-style : solid;color: black;border-radius: 5px;font-size: medium"
                                          type="submit" value="View Edit Blog" name="btnAction">
                                    Edit Blog
                                </button>
                            </td>
                            </tr>
