<%-- 
    Document   : createtag
    Created on : 30-09-2021, 19:37:04
    Author     : Admin
--%>
                    ...
                    <div class="row gx-4 gx-lg-5 justify-content-center">
                        <div class="col-md-10 col-lg-8 col-xl-7">
                            <div class="page-heading">
                                <h1 style="font-style: italic;font-size: 3.5rem">Create new Tag</h1>
                                        ...
                                        <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                                            <div class="form-floating">
                                                <input class="form-control" style="background-color: #d9e4f5;
                                                       background-image: linear-gradient(315deg, #d9e4f5 0%, #f5e3e6 74%);" name="txtTagId"  type="text" placeholder="SubjectID" >
                                                <label for="TagID" style="color: darkblue">Tag ID</label>
                                                <td>
                                            ...
                                            <div class="form-floating">
                                                <input class="form-control" style="background-color: #d9e4f5;
                                                       background-image: linear-gradient(315deg, #d9e4f5 0%, #f5e3e6 74%);" name="txtTagName" type="text" placeholder="SubjectName"  />
                                                <label for="TagName" style="color: darkblue">Tag Name</label>  
                                                <td>
                                            ...
                                            <div style="text-align: center">
                                                <button  class="btn btn-primary text-uppercase"  type="submit" name="btnAction" value="Create Tag" style="background-color: black;width: 500px;border-radius: 25px">Create</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
