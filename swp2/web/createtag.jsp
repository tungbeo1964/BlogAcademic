                                ...
                                <div class="my-5">
                                    ...
                                    <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                                        <div class="form-floating">
                                            <input class="form-control" name="txtTagId"  type="text" placeholder="SubjectID" >
                                        ...
                                        <div class="form-floating">
                                            <input class="form-control" name="txtTagName" type="text" placeholder="SubjectName"  />
                                        ...
                                        <!-- Submit Button-->
                                        <button  class="btn btn-primary text-uppercase"  type="submit" name="btnAction" value="Create Tag">Create</button>
                                    </form>
                                </div>
                            </div>
                        </div>
