                                ...
                                <div class="my-5">
                                    ...
                                    <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                                        <div class="form-floating">
                                            <input class="form-control" name="txtSubjectID"  type="text" placeholder="SubjectID" >
                                            <label for="SubjecID">Subject ID</label>
                                            <td>
                                        ...
                                        <div class="form-floating">
                                            <input class="form-control" name="txtSubjectName" type="text" placeholder="SubjectName"  />
                                        ...
                                        <!-- Submit Button-->
                                        <button  class="btn btn-primary text-uppercase"  type="submit" name="btnAction" value="Create Subject">Create</button>
                                    </form>
                                </div>
                            </div>
                        </div>
