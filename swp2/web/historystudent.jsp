                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <form action="MainController" method="GET">
                                                    ...
                                                    <td>${listHistoryBlog.title}</td>
                                                    <td>${listHistoryBlog.createOn}</td>
                                                    <td>${listHistoryBlog.approveOn}</td>
                                                    <td>
                                                        ...
                                                        <c:if test="${listHistoryBlog.approveBy eq -1}">
                                                            <font color="red"><c:out value="Waiting"/></font>
                                                        </c:if>  
                                                    </td>           
                                                    <td>
                                                        ...
                                                        <c:if test="${listHistoryBlog.status eq 2}">
                                                            <font color="blue" ><c:out value="Approve"/></font>
                                                        </c:if>
