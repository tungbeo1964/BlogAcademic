...
public class MainController extends HttpServlet {
    ...
    private final String EDIT_BLOG_STUDENT_SERVLET = "EditBlogStudentServlet";
    
    private final String VIEW_EDIT_BLOG_MENTOR_SERVLET = "ViewEditBlogMentorServlet";
    private final String EDIT_BLOG_MENTOR_SERVLET = "EditBlogMentorServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            } else if(button.equals("Edit blog")){
                url = EDIT_BLOG_STUDENT_SERVLET;
