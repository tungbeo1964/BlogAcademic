...
public class DeleteVideoServlet extends HttpServlet {
    ...
    private final String PAGE = "ViewEditBlogStudentServlet"; 
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String id = request.getParameter("txtVideoId");
        try {
            int vidId = Integer.parseInt(id);
            VideoDAO videoDAO = new VideoDAO();
            videoDAO.deleteBlogVideo(vidId);
