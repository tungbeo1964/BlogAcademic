...
@WebServlet(name = "ViewBlogDetailStudentServlet", urlPatterns = {"/ViewBlogDetailStudentServlet"})
public class ViewBlogDetailStudentServlet extends HttpServlet {

    private final String BLOG_DETAIL_PAGE = "blogDetailStudent.jsp";
