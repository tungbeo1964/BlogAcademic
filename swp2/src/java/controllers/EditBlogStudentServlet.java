...
@WebServlet(name = "EditBlogStudentServlet", urlPatterns = {"/EditBlogStudentServlet"})
public class EditBlogStudentServlet extends HttpServlet {

    private final String SUCCESS = "ViewHistoryBlogStudentServlet";
    private final String FAIL = "ViewEditBlogStudentServlet";
        ...
        try {
            ...
            if (isMP) {
                ...
                try {
                    ...
                    int tempId = blogDAO.titleIsExisted(title);
                    if (tempId != -1 && tempId != blogId) {
                        valid = false;
                    ...
                    if (valid) {
                        ...
                        url = "MainController?txtBlogId=" + id +"&btnAction=View+This+Blog+to+Edit";
