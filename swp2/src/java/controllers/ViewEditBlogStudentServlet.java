...
@WebServlet(name = "ViewEditBlogStudentServlet", urlPatterns = {"/ViewEditBlogStudentServlet"})
public class ViewEditBlogStudentServlet extends HttpServlet {

    private final String EDIT_BLOG_PAGE_STUDENT = "editblogstudent.jsp";
    private final String HISTORY_PAGE_STUDENT = "historystudent.jsp";
