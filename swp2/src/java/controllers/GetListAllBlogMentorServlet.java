...
@WebServlet(name = "GetListAllBlogMentorServlet", urlPatterns = {"/GetListAllBlogMentorServlet"})
public class GetListAllBlogMentorServlet extends HttpServlet {

    private final String HOME_PAGE = "mentor.jsp";
