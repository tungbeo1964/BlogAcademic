 ...
 * @author DELL
 */
@WebServlet(name = "CreateBlogMentorServlet", urlPatterns = {"/CreateBlogMentorServlet"})
public class CreateBlogMentorServlet extends HttpServlet {

    private final String SUCCESS = "GetListAllBlogMentorServlet";
    private final String FAIL = "ViewCreateBlogMentorServlet";
                ...
                try {
                    ...
                    if (valid) {
                        ...
                        for (int i = 0; i < videos.size(); i++) {
                            ...
                            System.out.println("Video nè: " + videos.get(i));
                        }
