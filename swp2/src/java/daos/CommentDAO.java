...
public class CommentDAO implements Serializable {
    ...
    public boolean deleteAllComment(int bid) throws SQLException, NamingException {
        Connection conn = null;
        PreparedStatement pstm = null;
        try {
            conn = DBConnection.makeConnection();
            if (conn != null) {
                String sql = "Delete From Comment Where content_id IN "
                        + "(SELECT content_id FROM Comment WHERE content_id=?)";
