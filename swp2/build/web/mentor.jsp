<%-- 
    Document   : mentor
    Created on : 29-09-2021, 20:06:27
    Author     : Admin
--%>
...
background-image: linear-gradient(315deg, #d9e4f5 0%, #f5e3e6 74%);">
        <c:if test="${not empty sessionScope.USER}">
            ...
            <!-- Page Header-->
            <header class="masthead" style="background-image: url('https://image.freepik.com/free-vector/hand-painted-watercolor-pastel-sky-background_23-2148907303.jpg');background-size: cover">
                <div class="container position-relative px-4 px-lg-5">
                    <div class="row gx-4 gx-lg-5 justify-content-center">
                        <div class="col-md-10 col-lg-8 col-xl-7">
                            <div class="site-heading">
                                <h1 style="font-size: 3.5rem; font-style: italic;">FU's Mentor Blog</h1>
                ...
                <div  class="left-sidebar">
                    ...
                    <form  style="padding-bottom: 25px;" action="MainController" method="POST">
                        <div class="input-group rounded">
                            ...
                            <input type="hidden" name="currentPage" value="mentor.jsp"/>
                    ...
                    <h2 class="h5-x" style="background-color: #d9e4f5;
background-color: #f5e3e6;color: black;margin-bottom: 20px;font-family: 'Open Sans'" >Subject</h2>
                    <div  class="link">
                        <c:forEach var="subject" items="${requestScope.LISTSUBJECT}">
                            <form method="POST">
                                <c:url var="searchSubject" value="MainController" >
                                    ...
                                    <c:param  name="currentPage" value="mentor.jsp"/>
                                </c:url>
                                        ...
                                        <form action="MainController" method="GET">
                                            ...
                                            <div class="post-preview" style="width: 18rem;">
                                                <div class="card-body" style="border: 1px solid black;margin-bottom: 20px;width: 30vw;font-family: monospace;border-radius: 5px;box-shadow:-4px 8px 8px rgba(0,0,0,0.1), -8px 16px 16px rgba(0,0,0,0.1), -16px 32px 32px rgba(0,0,0,0.15), -32px 64px 64px rgba(0,0,0,0.25);margin-top: 6vh">
                                                    ...
                                                    <button type="submit" value="View Blog Detail Mentor" name="btnAction" class="btn btn-primary" style="background-color: black">
                                                        View Blog
                                                    </button>
                                                </div>
                                            </div>
