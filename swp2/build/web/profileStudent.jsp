                    ...
                    <div class="row gx-4 gx-lg-5 justify-content-center">
                        <div class="col-md-10 col-lg-8 col-xl-7">
                            <div class="page-heading">
                                <h1 style="font-style: italic;font-size: 3.5rem">Your Profile</h1>
                        ...
                        <form action="MainController" method="POST">
                            ...
                            <div class="row gx-4 gx-lg-5 justify-content-center" >
                                <div class="col-md-10 col-lg-8 col-xl-7" style="padding-left: 3vw">
                                    <div id="wizard" style="height: 650px;background: no-repeat;border: solid black 2px" >
                                        <!-- SECTION 1 -->
                                        ...
                                        <div class="form-header" >
                                            <div class="avartar">
                                                <a href="#" style="margin-right: 100px;">
                                                    <img style="border-style: solid;border-radius: 10px;box-shadow:-4px 8px 8px rgba(0,0,0,0.1), -8px 16px 16px rgba(0,0,0,0.1), -32px 64px 64px rgba(0,0,0,0.25);" src="images/student.png" alt="">
                                                </a>

                                            </div>
                                            <div class="form-group">
                                                <input type="hidden" name="txtID" value="${accDTO.id}"/>
                                                <span style="color: red;padding-left: 20px;font-size: 20px;">Username</span>
                                                ...
                                                <span style="color: orange;padding-left: 20px;font-size: 20px;">Fullname</span>
                                                <div style="padding-bottom: 10px;padding-top: 10px;"></div>
                                                ...
                                                <span style="color: orange;padding-left: 20px;font-size: 20px;">Phone</span>
                                                <div style="padding-bottom: 10px;padding-top: 10px;"></div>
                                                <div class="form-holder">
                                                    <input style="border:  4px solid;border-color: #d9e4f5;background-color: #ffffff;
                                                           background-image: linear-gradient(315deg,#f5e3e6 0%, #ffffff 74% );box-shadow:-4px 8px 8px rgba(0,0,0,0.1), -8px 16px 16px rgba(0,0,0,0.1), -32px 64px 64px rgba(0,0,0,0.25);" type="text" name="txtPhone" value="${studentDTO.phone}" placeholder="Phone"  class="form-control">
                                                    <td>
                                                ...
                                                <span style="color: orange;padding-left: 20px;font-size: 20px;">Email</span>
                                                <div style="padding-bottom: 10px;padding-top: 10px;"></div>
                                                <div class="form-holder">
                                                    <input style="border:  4px solid;border-color: #d9e4f5;background-color: #ffffff;
                                                           background-image: linear-gradient(315deg,#f5e3e6 0%, #ffffff 74% );box-shadow:-4px 8px 8px rgba(0,0,0,0.1), -8px 16px 16px rgba(0,0,0,0.1), -32px 64px 64px rgba(0,0,0,0.25);" type="text" name="txtEmail" value="${studentDTO.email}" placeholder="Email"  class="form-control">                                
                                                    <td>
                                        ...
                                        <button  style="background-color: black;
                                                 color: white;box-shadow:-4px 8px 8px rgba(0,0,0,0.1), -8px 16px 16px rgba(0,0,0,0.1), -32px 64px 64px rgba(0,0,0,0.25);" type="submit" name="btnAction" value="Update Profile" class="login100-form-btn">
                                            Save
                                        </button>
                                    </div>
                                </div>
