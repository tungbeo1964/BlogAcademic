<%-- 
    ...
    Created on : 30-09-2021, 19:52:24
    Author     : Admin
--%>
                    ...
                    <div class="row gx-4 gx-lg-5 justify-content-center">
                        <div class="col-md-10 col-lg-8 col-xl-7">
                            <div class="page-heading">
                                <h1 style="font-style: italic;font-size: 3.5rem">Create Mentor</h1>
                            ...
                            <div class="col-md-10 col-lg-8 col-xl-7">
                                ...
                                <div class="my-5">
                                    ...
                                    <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                                        <div style="border: solid;padding: 55px;border-radius: 10px">
                                        <div class="form-floating" >
                                            <input class="form-control" style="background-color: #d9e4f5;
background-image: linear-gradient(315deg, #d9e4f5 0%, #f5e3e6 74%);" type="text" name="mentorID" value="${param.mentorID}" placeholder="CreateMentor" >
                                            <label for="ID" style="color: darkblue">ID</label>
                                            <td>
                                        ...
                                        <div class="form-floating">
                                            <input class="form-control" style="background-color: #d9e4f5;
background-image: linear-gradient(315deg, #d9e4f5 0%, #f5e3e6 74%);" type="text" name="mentorName" value="${param.mentorName}" placeholder="CreateMentor">
                                        ...
                                        <div class="form-floating">
                                            <input class="form-control" style="background-color: #d9e4f5;
background-image: linear-gradient(315deg, #d9e4f5 0%, #f5e3e6 74%);" type="text" name="mentorEmail" value="${param.mentorEmail}" placeholder="CreateMentor">
                                        ...
                                        <div class="form-floating">
                                            <input class="form-control" style="background-color: #d9e4f5;
background-image: linear-gradient(315deg, #d9e4f5 0%, #f5e3e6 74%);" type="text" name="mentorPhone" value="${param.mentorPhone}" placeholder="CreateMentor">
                                            <label for="phone" style="color: darkblue">Phone Number</label>
                                            <td>
                                        ...
                                        <div class="form-floating">
                                            <input class="form-control" style="background-color: #d9e4f5;
background-image: linear-gradient(315deg, #d9e4f5 0%, #f5e3e6 74%);" type="password" name="mentorPassword" placeholder="CreateMentor">
                                        ...
                                        <div class="form-floating">
                                            <input class="form-control" style="background-color: #d9e4f5;
background-image: linear-gradient(315deg, #d9e4f5 0%, #f5e3e6 74%);" type="password" name="txtConfirm" placeholder="CreateMentor" >
                                            <label for="Password" style="color: darkblue">Confirm Password</label>
                                            <td>
                                        ...
                                        <button class="btn btn-primary text-uppercase" type="submit" name="btnAction" value="Create Mentor" style="background-color: black;width: 500px;border-radius: 25px">
                                            Create
                                        </button>
                                            </div>
                                    </form>
